...
export const LoginPage: React.FC = () => {
  const { loginWithGoogle, loginWithPreset } = useAuth();
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        >
          ...
          <p className="text-center text-[11px] leading-relaxed" style={{ color: 'var(--text-muted)' }}>
            We only support sign in with Google — no passwords to remember or leak.
          </p>

          {/* Demo shortcuts */}
          <div className="pt-1 border-t space-y-3" style={{ borderColor: 'var(--border)' }}>
            <p className="text-[10px] font-bold uppercase tracking-widest pt-4" style={{ color: 'var(--text-muted)' }}>
              Or preview a demo profile
            </p>
